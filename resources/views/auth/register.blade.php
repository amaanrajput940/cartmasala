...
<div class="min-h-screen flex items-center justify-center">
    <div class="max-w-md mx-auto bg-white rounded-3xl shadow-xl p-8">
        <h1 class="text-2xl font-semibold text-center mb-6">Register for CartMasala</h1>

        <form method="POST" action="{{ route('register') }}">
            @csrf

            <div class="mb-4">
                <label for="name" class="block text-sm text-[#7d6f53] mb-2">Name</label>
            ...
            <div class="mb-6">
                <label for="password_confirmation" class="block text-sm text-[#7d6f53] mb-2">Confirm Password</label>
        ...
        <p class="text-center mt-6 text-sm text-[#4d4a47]">
            ...
            <a href="{{ route('login') }}" class="text-[#f53003] hover:text-[#d42a00]">Login here</a>
        </p>
    </div>
</div>
@endsection
